...
export const OPEN_CAPABILITY_REGISTRY = [
  ...
  },
  {
    ...
    triggers: ['file', 'document', 'pdf', 'docx', 'excel', 'spreadsheet', '文件', '文档', '表格', '报告', '整理', '生成'],
    agentRole: 'Builder',
    ...
    integrationStatus: 'planned',
    evaluation: 'Add file artifact eval for read, write, overwrite block, and artifact review.',
  },
  {

...
export const OPEN_CAPABILITY_REGISTRY = [
  ...
  },
  {
    ...
    triggers: ['memory', 'remember', 'context', 'preference', 'project context', '记忆', '记住', '记一下', '记得', '上下文', '偏好', '用户偏好', '项目背景', '资料'],
    ...
    integrationStatus: 'adapter-ready',
    evaluation: 'test:vela-mission covers mission memory references, provenance, recall trace, review evidence, and skipped hidden long-term write.',
  },
  {
